...
1. **시간대·반 목록** — 어떤 시간대에 어떤 반이 열리는지. Alan이 정리해서 전달 예정.
   ...
   **아직 확정 안 된 것**
   ...
   - **방학달(7·8월) 시간대를 어디에 담을지.** `timetable_slots` 에는 달 구분이 없어 레벨당 한 세트뿐인데
     평달과 방학달이 다르다. 시간대에 적용 기간을 붙일지, 일괄 개설 표에서 그 달만 고칠지 Alan 에게 확인하고 정한다.
     **그때까지 방학달(7·8·1·2월) 반은 만들지 말 것.**
