...
export const STUDENT_FEATURES: StudentFeature[] = [
  ...
  },
  {
    ...
    label: "숙제업로드",
    icon: "homework",
    // 정규 수업 숙제다 — 비대면 스터디 인증(내 스터디)과 섞지 않는다 (2026-09-19 · 09-23 Alan).
    // 레벨 → RC/LC → 사진 3단계는 2026-09-19 에 수업 달력으로 바뀌었다
    summary: "정규 수업 RC·LC 숙제 사진 제출",
    desc: "내 수업 달력에서 날짜를 고르고 그 날 RC·LC 숙제 사진을 올려요. 궁금한 점도 함께 적을 수 있고, 강사가 확인하면 점검완료 알림이 와요.",
    points: ["수업 달력에서 날짜 → RC/LC 제출", "질문도 함께, 점검 결과는 알림으로"],
    access: "active",
  },
  {
    key: "study",
